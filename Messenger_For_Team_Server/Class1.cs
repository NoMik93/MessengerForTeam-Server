...
namespace soket
{
    public enum PacketType
    {
        ...
        전체채팅방검섹,             //userID    패킷                 //Select [chatInfo data] from [chat table]
        ...
        //일정 관련
        채팅방일정,                 //chatID       패킷              //Select [calender Info] from [calender table] where chatID
        일정추가,                   //CalenderInfo 패킷              //insert
        일정삭제,                   //CalenderInfo 패킷              //delete
        개인일정,                   //userID       패킷              //Select [calender Info] from [calender table] where userID
    ...
    [Serializable]
    public class CalenderInfo : Packet              //캘린더 전송 패킷
    {
